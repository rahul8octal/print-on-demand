...
$baseUrl = trim(env('APP_WEBHOOK_URL', env('APP_URL', '')), '/');
...
return [
    ...
    */
    ...
    'app_name' => env('SHOPIFY_APP_NAME', 'Octal: 3d configuration'),
    ...
    */
    ...
    'webhooks' => [
        [
            ...
            'job' => \App\Jobs\AppUninstalledJob::class
        ],
        [
            'topic' => 'SHOP_REDACT',
            'address' => "$baseUrl/webhook/shop-redact"
        ],
        [
            'topic' => 'CUSTOMERS_REDACT',
            'address' => "$baseUrl/webhook/customers-redact"
        ],
    ...
    */
    ...
    'job_queues' => [
        'webhooks' => env('WEBHOOKS_JOB_QUEUE', 'default'),
    ...
    */
    ...
    'iframe_ancestors' => 'https://admin.shopify.com https://*.myshopify.com',
